###############################################################################
# This file contains the model class for the combination of STGAN and SIDwithI
# STGAN is in charge of detecting shadow. SIDwithI is for removing shadow.
###############################################################################
...
class SIDPAMIwISTGANModel(BaseModel):
    def name(self):
        return 'Physics-based Shadow Image Decomposition for Shadow Removal & STGAN'
    ...
    def initialize(self, opt):
        ...
        self.netG2 = define_SIDPAMIwINet(opt, net_g = opt.netS, net_m = opt.netG, net_i = opt.netG)
