...
#NOTE: modify MODELS in FOR LOOP, and modify 'model_lists' at the beginning of Compute_PNSR_SSIM.ipynb
loop_string=200
...
eval "jupyter notebook $(pwd)/Compute_PNSR_SSIM.ipynb" #Open .sh file by in anaconda environment
$SHELL 
